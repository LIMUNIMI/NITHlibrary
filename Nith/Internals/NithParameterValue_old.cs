...
namespace NITHlibrary.Nith.Internals
{
    ...
    /// </summary>
    public struct NithParameterValue_old
    {
        /// <summary>
        ...
        public NithParameterValue_old(NithParameters parameter, string baseAndMax)
        {
        ...
        public NithParameterValue_old(NithParameters parameter, string @base, string max)
        {
            Type = NithDataTypes.Range;
            this.Base = @base;
